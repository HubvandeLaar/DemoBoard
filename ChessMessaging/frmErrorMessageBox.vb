...
Public Class frmErrorMessageBox
    ...
    Public Overloads Shared Sub Show(ByVal pException As Exception)
        Using frmErrorMessageBox As New frmErrorMessageBox()
            frmErrorMessageBox.Exception = pException
            frmErrorMessageBox.CenterToScreen()

            Application.DoEvents()
            frmErrorMessageBox.ShowDialog()
        End Using
    End Sub
    ...
    ''' <summary>Returns only the FileName out of a FullFileName</summary>
    Public Shared Function RemoveDirectories(pStackTrace As String) As String
        Try
